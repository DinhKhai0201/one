      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?php echo html_helpers::url(array('ctl'=>'about')); ?>">About</a></li>
            <li><a href="<?php echo html_helpers::url(array('ctl'=>'students')); ?>">Management students</a></li>
            <li><a href="<?php echo html_helpers::url(array('ctl'=>'contact')); ?>">Contact</a></li>
            <!--li class="dropdown">
